...
2026-09-13 前端改为多邮箱工作台：首页并列展示邮件和 Agent 对话栏，可直接聊天，也可展开问答工作台继续同一会话。真实邮件仍仅在本地读取与搜索，对话当前使用独立问答资料。当前支持163，QQ等接入后续补充。设计与验证见 [多邮箱界面说明](docs/frontend-mail-workspace-2026-09-13.md)。
